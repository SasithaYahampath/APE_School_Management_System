...
<head>
    ...
    <title>Edit Lecture Slide</title>
...
<body>
    ...
    <div class="container">
        <h1>Edit Lecture Slide for ${course.courseCode}</h1>
        
        <form action="lectures?action=update" method="post">
            ...
            <div class="form-group">
                ...
                <textarea id="description" name="description" rows="4">${slide.description}</textarea>
            </div>
            ...
            <div class="form-actions">
                <button type="submit" class="btn">Update Slide</button>
