...
<body>
    ...
    <div class="container">
        ...
        <form action="courses?action=update" method="post">
            ...
            <div class="form-group">
                ...
                <select id="department" name="department" required>
                    ...
                    <option value="Science" ${course.department == 'Science' ? 'selected' : ''}>Science</option>
                    <option value="Languages" ${course.department == 'Languages' ? 'selected' : ''}>Languages</option>
                </select>
            </div>
            
            <div class="form-group">
                <label for="credits">Credits:</label>
                <input type="number" id="credits" name="credits" min="1" max="10" value="${course.credits}" required>
            </div>
