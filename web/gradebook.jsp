    ...
    <div class="card mb-4">
        <div class="card-header">
            <ul class="nav nav-tabs card-header-tabs">
                <li class="nav-item">
                    <a class="nav-link active" href="gradebook.jsp">Gradebook</a>
                </li>
                <li class="nav-item">
                ...
                <table class="table table-bordered table-hover">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th colspan="3" class="text-center">Assignments (40%)</th>
                            <th colspan="2" class="text-center">Exams (60%)</th>
                ...
                <div class="card-body">
                    <ul class="list-group">
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            Physics Quiz 1
                            <span class="badge bg-primary rounded-pill">Avg: 78%</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            Java Project
                            <span class="badge bg-primary rounded-pill">Avg: 85%</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            Math Assignment 1
                            <span class="badge bg-primary rounded-pill">Avg: 89%</span>
                        </li>
                    </ul>
                </div>
            </div>
